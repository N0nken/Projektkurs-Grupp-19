...
int init_server(Server *server, GameState *gameState) {
    ...
    Player_set_position(gameState->players[0], create_Vector2(1920/2, 200));
    Player_set_position(gameState->players[0], create_Vector2(1920/2, 1080-200));
    Player_set_position(gameState->players[0], create_Vector2(1920-400, 1080-400));
    return 0;
}
